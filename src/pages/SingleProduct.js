...
const SingleProduct = () => {
  ...
  const props = {
    ...
    height: 500,
    zoomWidth: 500,
    img: "https://cdn.pixabay.com/photo/2021/11/16/15/35/technology-6801334_960_720.jpg",
  };
  ...
  return (
    <>
        ...
        <div className="row">
          <div className="col-6">
            ...
            <div className="other-product-image d-flex flex-wrap gap-10">
              <div>
                <img
                  src="https://cdn.pixabay.com/photo/2021/11/16/15/35/technology-6801334_960_720.jpg"
                  alt="pic"
                  className="img-fluid"
                />
              </div>
              ...
              <div className="border-bot">
                ...
                <div className="d-flex gap-10 flex-column my-2">
                  ...
                  <div className="d-flex flex-wrap gap-15">
                    <span className="badge bg-white border border-secondary text-dark">
                      S
                    </span>
                    <span className="badge bg-white border border-secondary text-dark">
                      M
                ...
                <div className="d-flex align-items-center gap-10 my-2 pe-2">
                  ...
                  <button
                    ...
                    className="link"
                  >
                    <em>Click here to copy product link</em>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="col-12">
            ...
            <div className="bg-white p-4">
              <p>
                ...
                incidunt id. Quos, porro molestias consequuntur reprehenderit
                quod facilis earum! Nesciunt, natus, ab recusandae officia est
                quaerat rem ducimus dicta numquam id maiores? Distinctio sequi,
                molestias officiis necessitatibus, veritatis libero accusamus
                ratione, maxime quisquam ipsa unde iste laudantium consequatur
                quos asperiores? ipsum dolor, sit amet consectetur adipisicing
                elit. Earum, consequatur sed quas consectetur fugiat a ex totam
                vel provident odio numquam? Error architecto blanditiis repellat
                provident minima commodi facere reprehenderit esse officiis
                tempora voluptatibus culpa quis corrupti eos dolorem, recusandae
                delectus harum ea, similique dolore! Eligendi, suscipit dolor.
                Voluptatem iure hic eligendi provident vitae esse, unde nisi vel
      ...
      <Container id="review" className="reviews-wrapper home-wrapper-2 px-5">
        <div className="row">
          <div className="col-12">
            <h4>Reviews</h4>
            <div className="review-inner-wrapper">
              ...
              <div className="reviews d-flex flex-column gap-10">
                <div className="review">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Quam provident aperiam placeat rerum deleniti optio vero.
                    Rem enim laboriosam aut!
                  </p>
                </div>
                <div className="review">
                  <div className="d-flex gap-10 align-items-center">
